...
class RestaurantReviewsControllerTest < ActionController::TestCase
  ...
  test "should create restaurant_review" do
    assert_difference('RestaurantReview.count') do
      post :create, restaurant_review: { comment: @restaurant_review.comment, hygiene: @restaurant_review.hygiene, parking: @restaurant_review.parking, restaurant_id: @restaurant_review.restaurant_id, service: @restaurant_review.service, user_id: @restaurant_review.user_id }
    end
  ...
  test "should update restaurant_review" do
    patch :update, id: @restaurant_review, restaurant_review: { comment: @restaurant_review.comment, hygiene: @restaurant_review.hygiene, parking: @restaurant_review.parking, restaurant_id: @restaurant_review.restaurant_id, service: @restaurant_review.service, user_id: @restaurant_review.user_id }
    assert_redirected_to restaurant_review_path(assigns(:restaurant_review))
  end
